<template>
  <div class="layout-header" style="width: 100%;position: fixed;left:0;top: 0;z-index: 14;background: #FDFCF8">
    <!--顶部菜单-->
    <div style="display: flex;color: #9C6643;font-weight: bolder;margin-left: 30px;align-items: center">
      <div>
        <img :src="websiteConfig.logo" style="width: 30px;height: 30px;margin-right: 10px" alt=""/>
      </div>
      <div>AEO审核系统后台</div>
    </div>
    <div
...
<!--      </n-breadcrumb>-->
    ...
    <div class="layout-header-right">
      <!--      <div class="" style="line-height: 64px">-->
...
export default defineComponent({
  name: 'PageHeader',
  components: {Moon, SunnySharp, ...components, NDialogProvider, ProjectSetting, AsideMenu},
  props: {
    collapsed: {
      type: Boolean,
    },
